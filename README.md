...
A estrutura do projeto está em `src/aula25`, e cada arquivo representa uma prática diferente.
...
Esse trecho mostra como TypeScript pode garantir que o objeto siga o formato definido pelo tipo `Pessoa`.

---

## Arquivo: `src/aula25/atividade01.ts`
...
## Arquivo: `src/aula25/atividade02.ts`
...
## Arquivo: `src/aula25/atividade03.ts`
...
## Arquivo: `src/aula25/atividade04.ts`

Este arquivo demonstra os principais tipos de laços em JavaScript/TypeScript.
